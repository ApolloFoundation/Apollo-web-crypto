...
function secp160k1() {
  ...
  var G = curve.decodePointHex(
    '04' + '3B4C382CE37AA192A4019E763036F4F5DD4D7EBB' + '938CF935318FDCED6BC28286531733C3F03C4FEE',
  );
  return new X9ECParameters(curve, G, n, h);
}
...
function secp160r1() {
  ...
  var curve = new ECCurveFp(p, a, b);
  var G = curve.decodePointHex(
    '04' + '4A96B5688EF573284664698968C38BB913CBFC82' + '23A628553168947D59DCC912042351377AC5FB32',
  );
  return new X9ECParameters(curve, G, n, h);
}
...
function secp192r1() {
  ...
  var curve = new ECCurveFp(p, a, b);
  var G = curve.decodePointHex(
    '04' + '188DA80EB03090F67CBF20EB43A18800F4FF0AFD82FF1012' + '07192B95FFC8DA78631011ED6B24CDD573F977A11E794811',
  );
  return new X9ECParameters(curve, G, n, h);
}
...
export { getSECCurveByName, X9ECParameters };
